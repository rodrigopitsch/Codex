...
@media (max-width:390px){.hud{grid-template-columns:1.15fr .68fr .68fr .58fr 1fr}.hudBox{padding:4px}.hudBox small{font-size:6px}.hudBox b{font-size:9px}.pad .ctl{width:78px;height:78px}.jump,.shoot{width:82px;height:82px}.acts{gap:8px}.pad{gap:7px}}
`;
